...
import sogang.capstoneDesign2.newSnack.auth.handler.OAuth2AuthenticationFailureHandler;
import sogang.capstoneDesign2.newSnack.auth.handler.OAuth2AuthenticationSuccessHandler;
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authenticationEntryPoint(
            new RestAuthenticationEntryPoint())   // 인증 없이 액세스할 때의 exception 처리: 401 Unauthorized
        .and()
